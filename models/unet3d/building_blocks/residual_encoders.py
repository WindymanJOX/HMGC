...
from ..building_blocks.residual import StackedResidualBlocks, BottleneckD, BasicBlockD
from ..building_blocks.helper import maybe_convert_scalar_to_list, get_matching_pool_op
...
class ResidualEncoder(nn.Module):
    def __init__(self,
                 ...
                 disable_default_stem: bool = True,
