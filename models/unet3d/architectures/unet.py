...
from ..building_blocks.unet_decoder import UNetDecoder, HMGCDecoder
...
class PlainConvUNet(nn.Module):
    def __init__(self,
        ...
        self.decoder = HMGCDecoder(self.encoder, num_classes, n_conv_per_stage_decoder, deep_supervision,
                                   nonlin_first=nonlin_first)
...
if __name__ == '__main__':
    ...
    model = PlainConvUNet(4, 6, (64, 128, 256, 512, 512, 512), nn.Conv3d, 
                         3, (1, 2, 2, 2, 2, 2), (2, 2, 2, 2, 2, 2), 3,
                        (2, 2, 2, 2, 2), True, nn.BatchNorm3d, None,
                        None, None, nn.LeakyReLU, deep_supervision=True)
